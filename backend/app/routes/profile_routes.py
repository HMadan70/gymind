...
def upsert_profile(
    ...
    if profile:
        ...
        profile = models.UserProfile(user_id=current_user.id, **profile_in.model_dump())
        db.add(profile)
...
def upsert_preferences(
    ...
    if preferences:
        ...
        preferences = models.UserPreference(user_id=current_user.id, **preferences_in.model_dump())
        db.add(preferences)
